...
def append_relatorio_dev(output_file, relatorio_dev_path, id_user_uuid):
    ...
    # Carrega o relatorio_dev e faz o append no documento principal
    dev_doc = Document(relatorio_dev_path)
    composer.append(dev_doc)

    # Define o nome do arquivo final com UUID
    final_output_path = os.path.join(os.getcwd(), f"{id_user_uuid}_relatorio_runbook.docx")
