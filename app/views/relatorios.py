...
def gerar_relatorio_thread(app_context, params, output_path):
    try:
        ...
        relatorio_status[params["id_user_uuid"]] = {
            ...
            "download_url": (f"http://10.5.8.145:8530/relatorios/download/{params['id_user_uuid']}")
        }
...
def status_relatorio(report_id):
    ...
    if status_info["status"] == "pronto":
        status_info["download_url"] = f"http://10.5.8.145:8530/relatorios/download/{report_id}"
